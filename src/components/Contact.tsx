  ...
  return (
    <div id="contact" className="flex flex-col w-[98%] mx-auto space-y-3 ">
      ...
      <div className="flex flex-col w-[98%] mx-auto space-y-4 relative">
        <div className="absolute z-[1] flex items-center justify-end top-[-35%] text-[rgba(255,255,255,0.04)] right-[-65%] h-full text-[20rem]">
          <p>CONTACT</p>
        </div>
        <div className="z-[10]">
          <h6>&lt;h2&gt;</h6>
        ...
        <div className=" space-y-5">
          ...
          <div className="flex flex-col w-[96%] mx-auto">
            <p className="text-white w-[50%]">{contactData.desc}</p>
          </div>
          <h6>&lt;/p&gt;</h6>
        </div>
        <div className="flex flex-col w-[98%] mx-auto space-y-4">
          ...
          <div className="flex flex-col w-[98%] mx-auto">
            <form
              onSubmit={sendEmail}
              ref={formRef}
              className="flex flex-col space-y-3 w-[50%]"
            >
